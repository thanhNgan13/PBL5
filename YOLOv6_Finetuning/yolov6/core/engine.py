...
class Trainer:
    ...
    def after_epoch(self):
        ...
        wandb.log({
                    "lr_test/lr0": lrs_of_this_epoch[0],
                    "lr_test/lr1": lrs_of_this_epoch[1],
                    "lr_test/lr2": lrs_of_this_epoch[2]})
        ...
        if self.main_process:
            ...
            # wandb.log({"mAP@0.5": self.evaluate_results[0], "mAP@0.50:0.95": self.evaluate_results[1], "lr": lrs_of_this_epoch[0], "iou_loss": self.mean_loss[0], "dfl_loss": self.mean_loss[1], "cls_loss": self.mean_loss[2]})
            wandb.log({"mAP@0.5": self.evaluate_results[0], "mAP@0.50:0.95": self.evaluate_results[1],"lr/lr0": lrs_of_this_epoch[0], "lr/lr1": lrs_of_this_epoch[1], "lr/lr2": lrs_of_this_epoch[2],"iou_loss": self.mean_loss[0], "dfl_loss": self.mean_loss[1], "cls_loss": self.mean_loss[2]})
